...
class DogfoodLoop:
    ...
    async def process_target(self, target_name):
        ...
        for attempt in range(3):
            ...
            try:
                log("Generating Keyframe with Flux Schnell (Fast Iteration)...")
                image_asset = await self.asset_manager.generate_image(image_prompt, model="fal-ai/flux/schnell")
                ...
                video_result = await asyncio.to_thread(handler.get)
